@include('partials.navbar')
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center mb-5">
            <div class="col-lg-6">
                <h1 class="display-1 mb-4 animated slideInRight">Solusi Digital <span class="text-primary">Koperasi</span>
                    Modern</h1>
                <h5 class="d-inline-block border border-2 border-white py-3 px-5 mb-0 animated slideInRight">
                    Membantu Anggota & Pengelola Koperasi Lebih Mudah dan Efisien
                </h5>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row g-5 animated fadeIn">
            <div class="col-md-6 col-lg-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="lh-base mb-0">Manajemen Anggota</h5>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="lh-base mb-0">Pengajuan dan Pengesahan Dokumen</h5>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="lh-base mb-0">Laporan Koperasi</h5>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 btn-square border border-2 border-white me-3">
                        <i class="fa fa-mobile-alt text-primary"></i>
                    </div>
                    <h5 class="lh-base mb-0">Akses Mudah via Aplikasi</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center wow fadeIn" data-wow-delay="0.1s">
                <h1 class="mb-5">Mengapa <span class="text-uppercase text-primary bg-light px-2">Pilih Kami</span></h1>
            </div>
            <div class="row g-5 align-items-center text-center">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <i class="fa fa-users fa-5x text-primary mb-4"></i>
                    <h4>Manajemen Anggota Terintegrasi</h4>
                    <p class="mb-0">Semua data anggota tersimpan rapi dan mudah diakses kapan saja secara digital.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <i class="fa fa-file-signature fa-5x text-primary mb-4"></i>
                    <h4>Pengajuan & Pengesahan Mudah</h4>
                    <p class="mb-0">Proses pengajuan dan pengesahan dokumen koperasi bisa dilakukan secara online tanpa ribet.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <i class="fa fa-chart-line fa-5x text-primary mb-4"></i>
                    <h4>Laporan Koperasi Transparan</h4>
                    <p class="mb-0">Dapatkan laporan keuangan yang akurat, real-time, dan transparan untuk semua anggota.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <i class="fa fa-mobile-alt fa-5x text-primary mb-4"></i>
                    <h4>Akses Mudah via Aplikasi</h4>
                    <p class="mb-0">Seluruh fitur koperasi tersedia dalam genggaman melalui aplikasi mobile yang praktis.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <i class="fa fa-headset fa-5x text-primary mb-4"></i>
                    <h4>Dukungan & Layanan Cepat</h4>
                    <p class="mb-0">Tim support selalu siap membantu anggota maupun pengurus kapan saja dibutuhkan.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <i class="fa fa-lock fa-5x text-primary mb-4"></i>
                    <h4>Keamanan Data Terjamin</h4>
                    <p class="mb-0">Data koperasi dan anggota terlindungi dengan sistem keamanan modern.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.2s">
                        ...
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="testimonial-text pb-5 pb-md-0">
                                    <h3>Mudah Mengelola Simpan Pinjam</h3>
                                    <p>"Aplikasi ini sangat membantu saya dalam memantau simpanan dan pinjaman. 
                                       Semua laporan jelas dan bisa diakses kapan saja."</p>
                    ...
                    <div class="testimonial-item">
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="testimonial-text pb-5 pb-md-0">
                                    <h3>Pengajuan Dokumen Lebih Cepat</h3>
                                    <p>"Tidak perlu lagi repot datang ke kantor koperasi. 
                                       Semua pengajuan dokumen bisa dilakukan lewat aplikasi."</p>
                                    <h5 class="mb-0">Siti Rahmawati</h5>
                    ...
                    <div class="testimonial-item">
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="testimonial-text pb-5 pb-md-0">
                                    <h3>Akses Laporan Transparan</h3>
                                    <p>"Laporan koperasi bisa saya lihat langsung lewat aplikasi. 
                                       Sangat transparan dan memudahkan semua anggota."</p>
                                    <h5 class="mb-0">Agus Pratama</h5>
                                    <small>Bendahara Koperasi</small>
                                </div>
                            </div>
                        </div>
                    </div>
