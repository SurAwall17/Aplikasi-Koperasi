                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a href="/pengajuan/edit/{{ $item->id }}" class="btn btn-sm btn-warning me-2"><i class="bi bi-pencil-square"></i></a>
                                    <form action="/pengajuan/delete/$item->id" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Hapus data?')"><i class="bi bi-trash"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
